  ...
  render: function() {
    return(
      React.createElement("li", {className: "list-group-item"}, 
        React.createElement("span", null, this.props.id, "."), " ", React.createElement("span", null, "Name: ", this.props.name), " ", React.createElement("span", null, "Age: ", this.props.age)
      )
      );
  }
});
...
},{"./ShowAddButton":1,"./UserForm":3,"./UsersList":5,"firebase":7,"react":163}],5:[function(require,module,exports){
/** @jsx React.DOM */
...
var UsersList = React.createClass({displayName: "UsersList",
  ...
  render: function() {
    ...
    var userList = this.props.users.map(function(user) {
      return React.createElement(User, {name: user.name, id: user.id, age: user.age});
    });
    return (
...
},{"./User":2,"react":163}],6:[function(require,module,exports){
/** @jsx React.DOM */
...
},{"./components/Users":4,"react":163}],7:[function(require,module,exports){
